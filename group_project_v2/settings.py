"""
Django settings for the xblock-group-project-v2 project.
...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'group_project_v2/translations'),
]
...
STATICI18N_NAMESPACE = 'GroupProjectV2XBlockI18N'
STATICI18N_PACKAGES = (
    'group_project_v2',
)
STATICI18N_ROOT = 'group_project_v2/public/js'
